...
namespace Xamarin.Forms
{
    ...
    public class TabViewItem : TemplatedView
    {
        ...
        public Color CurrentBadgeBackgroundColor
        {
            get
            {
                return (Color)GetValue(CurrentBadgeBackgroundColorProperty);
            }
            private set
            {
                SetValue(CurrentBadgeBackgroundColorPropertyKey, value);
            }
        }
        ...
        public View CurrentContent
        {
            get
            {
                return (View)GetValue(CurrentContentProperty);
            }
            private set
            {
                SetValue(CurrentContentPropertyKey, value);
            }
        }
        ...
        internal void UpdateCurrentContent(bool isOnScreen = true)
        {
            ...
            var newCurrentContent = _isOnScreen ? Content : null;
